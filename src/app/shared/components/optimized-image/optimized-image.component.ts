...
import { ImageOptimizationService, ResponsiveImageSet } from '../../../core/services/image-optimization.service';
...
@Component({
    ...
    <div class="image-container" [class.loading]="isLoading()" [class.error]="hasError()">
      ...
      <!-- Error state -->
      <div *ngIf="hasError()" class="image-error" [style.width.px]="width" [style.height.px]="height">
...
export class OptimizedImageComponent implements OnInit, OnDestroy {
    ...
    @Input() height: number = 384;
    @Input() lazy: boolean = true;
    @Input() placeholder?: string;
    @Input() fallback: string = '/assets/images/book-placeholder.png';
    ...
    async ngOnInit() {
        ...
        this.responsiveSet = this.imageOptimizationService.generateResponsiveImageSet(this.src, this.alt);
    ...
    private setupLazyLoading(): void {
        this.observer = this.imageOptimizationService.createLazyLoader((entries: IntersectionObserverEntry[]) => {
