...
describe('OptimizedImageComponent', () => {
  ...
  const mockResponsiveImageSet = {
    ...
    srcset:
      'https://example.com/book-128.jpg 128w, https://example.com/book-256.jpg 256w, https://example.com/book-512.jpg 512w',
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      ...
      providers: [{ provide: ImageOptimizationService, useValue: spy }],
    }).compileComponents();

    fixture = TestBed.createComponent(OptimizedImageComponent);
    component = fixture.componentInstance;
    mockImageOptimizationService = TestBed.inject(
      ImageOptimizationService,
    ) as jasmine.SpyObj<ImageOptimizationService>;

    // Setup default mocks
    mockImageOptimizationService.generateResponsiveImageSet.and.returnValue(mockResponsiveImageSet);
    mockImageOptimizationService.generatePlaceholder.and.returnValue(
      'data:image/png;base64,placeholder',
    );
    mockImageOptimizationService.createLazyLoader.and.returnValue(
      jasmine.createSpyObj('IntersectionObserver', ['observe', 'disconnect']),
    );
    mockImageOptimizationService.preloadImage.and.returnValue(
