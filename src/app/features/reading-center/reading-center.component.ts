              ...
              <div class="history-content">
                ...
                <ng-template #noHistory>
                  <div class="empty-state">
                    ...
                    <button mat-button routerLink="/search" color="primary">Start Searching</button>
                  </div>
                </ng-template>
              </div>
            ...
            <div class="reading-list-content">
              ...
              <ng-template #noBooks>
                <div class="empty-state">
                  ...
                  <button mat-button routerLink="/search" color="primary">Find Books to Add</button>
                </div>
              </ng-template>
            </div>
          </mat-card-content>
                ...
                <div class="recommendation-content">
                  ...
                  <div class="recommendation-actions">
                    ...
                    <button
                      ...
                      [attr.aria-label]="
                        (isFavorite(book.id) ? 'Remove from' : 'Add to') + ' favorites'
                      "
                    >
                      <mat-icon>{{
                        isFavorite(book.id) ? 'favorite' : 'favorite_border'
                      }}</mat-icon>
                    </button>
                  </div>
                </div>
        ...
        <mat-card class="section-card">
          ...
          <mat-card-content>
            <div class="actions-grid">
              ...
              <button mat-button (click)="exportData()" aria-label="Export your reading data">
        ...
        this.bookService.searchBooks({ query: category, maxResults: 6 }).subscribe({
          next: (result) => {
            ...
            const newBooks = result.books.filter(
              (book) => !favorites.some((fav) => fav.id === book.id),
            );
