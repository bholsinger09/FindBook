...
export function passwordMatchValidator(control: AbstractControl): Record<string, any> | null {
          ...
          <form [formGroup]="registerForm" (ngSubmit)="onSubmit()" class="register-form">
            ...
            <mat-form-field appearance="outline" class="full-width">
              ...
              <mat-error *ngIf="isFieldInvalid('password')">
                ...
                <span *ngIf="registerForm.get('password')?.errors?.['pattern']"
                  >Password must contain at least 8 characters with letters and numbers</span
                >
              </mat-error>
            </mat-form-field>
            ...
            <mat-form-field appearance="outline" class="full-width">
              ...
              <input
                ...
                [class.error]="
                  isFieldInvalid('confirmPassword') || registerForm.errors?.['passwordMismatch']
                "
              />
              <button
                type="button"
              ...
              <mat-error
                *ngIf="
                  registerForm.errors?.['passwordMismatch'] && !isFieldInvalid('confirmPassword')
                "
              >
