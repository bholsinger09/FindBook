...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, MatButtonModule, MatIconModule, MatTooltipModule, MatSlideToggleModule],
  template: `
    <div class="accessibility-toolbar" role="toolbar" aria-label="Accessibility Options">
      ...
      <div class="toolbar-content" [class.expanded]="isExpanded" [attr.aria-hidden]="!isExpanded">
...
export class AccessibilityToolbarComponent {
  ...
  toggleToolbar(): void {
    ...
    this.accessibilityService.announce(
      this.isExpanded ? 'Accessibility toolbar opened' : 'Accessibility toolbar closed',
    );
  }
