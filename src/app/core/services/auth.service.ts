...
export class AuthService {
    ...
    socialAuth(request: SocialAuthRequest): Observable<SocialAuthResponse> {
        ...
        return this.http.post<SocialAuthResponse>(`${this.API_BASE_URL}/auth/social`, request).pipe(
            tap((response) => {
                if (response.success && response.data) {
                    this.handleAuthSuccess(response.data);
                }
    ...
    logout(): Observable<any> {
        ...
        if (refreshToken) {
            return this.http.post(`${this.API_BASE_URL}/auth/logout`, { refreshToken }).pipe(
    ...
    requestPasswordReset(email: string): Observable<PasswordResetResponse> {
        ...
        return this.http
            .post<PasswordResetResponse>(`${this.API_BASE_URL}/auth/password-reset`, request)
    ...
    changePassword(request: PasswordChangeRequest): Observable<PasswordChangeResponse> {
        return this.http
            .post<PasswordChangeResponse>(`${this.API_BASE_URL}/auth/password-change`, request)
            .pipe(catchError((error) => this.handleAuthError(error)));
    }
    ...
    updateProfile(updates: Partial<User>): Observable<User> {
        return this.http
            .put<{ success: boolean; data: User }>(`${this.API_BASE_URL}/user/profile`, updates)
            .pipe(
